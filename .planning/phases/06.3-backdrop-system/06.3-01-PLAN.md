...
Follow the exact pattern used by LightConfig and GelConfig for consistency.
  ...
  <verify>python3 -c "from lib.cinematic.types import BackdropConfig; c = BackdropConfig(); assert c.curve_height == 3.0; assert c.curve_segments == 32; print('BackdropConfig extended OK')"</verify>
  <done>BackdropConfig supports all backdrop types with proper serialization</done>
</task>
